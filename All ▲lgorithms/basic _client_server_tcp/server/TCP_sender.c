...
Name         : TCP_Sender.c
Author       : GodisCOOL
Description  : Simples TCP sender. Expected input {Local IP address, port} send a message to the other side until message is "Bye".
=======================
*/
...
int main(int argc, char *argv[]){
    ...
    * 1) Internet domain 2) Stream socket 3) Default protocol (TCP in this case)*/
    ...
    /*---- Configure settings of the the server address struct ----
